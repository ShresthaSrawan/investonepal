...
<section class="main-content col-md-9 no-padding">
    <div class="row commodity-type-selector no-margin">
        <div class="col-md-3">
            {!! Form::select('bullion_type',$bullionTypes,$bullionID,['class'=>'form-control chart-selector']) !!}
        </div>
        <div class="col-md-9">
            <span class="compare-chart-selector">
                {!! Form::select('bullion_type',$bullionTypes,$bullionID,['class'=>'form-control mymulti','multiple'=>'multiple']) !!}
            </span>
        </div>
    </div>
    ...
    <div class="row no-margin">
        <div class="col-sm-12">
            <p class="commodity-table"><i class="fa fa-cubes"></i> Price of <span data-role="bullion" class="commodity-type"></span> per 10 grams.</p>
            <table class="table datatable bullion responsive table-striped table-condensed table-hover with-border" width="100%">
                <thead>
                    <tr>
    ...
    <div class="panel panel-default no-padding">
        ...
        <div class="panel-body no-padding">
            <ul class="unlist no-padding">
                <li>
                    <h4 class="aside-heading"><a href="{{route('front.news.category','bullion')}}" class="link">Bullion</a></h4>
...
<script type="text/javascript">
    var getBullionURL = "{{route('api-get-bullion')}}";
    var getBullionDatatableURL = "{{route('api-get-bullion-datatable')}}";
</script>
...
{!! HTML::script('assets/nsm/front/js/bullion.js') !!}
<script type="text/javascript">
