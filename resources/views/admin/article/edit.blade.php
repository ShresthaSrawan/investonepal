...
<?php
    if(!array_key_exists("newsCategory", old())):
        $selected = isset($article) ? $article->category->id : null;
    else:
...
<div class="box box-info">
    {!! Form::model($article,['route' => ['admin.article.update',$article->id],'method'=>'put','files'=>true,'novalidate'=>'']) !!}
        <div class="box-header with-border">
            <h3 class="box-title">
                <i class="fa fa-microphone fa-fw"></i> Article :Edit:
            </h3>
    ...
    <div class="box box-info">
        ...
        <div class="box-body">
            <div class="col-md-6 pull-right">
                <h4>Writer: {{ucwords($article->externalDetail->name)}}</h4>
                <div class="thumbnail">
                    @if(is_null($article->externalDetail->photo) || $article->externalDetail->photo == "")
                        <img src="http://placehold.it/150x150/dddddd/333333?text=NA" class="img-responsive">
                    @else
                        <img src="{{url('/').'/ia_external_photo/'.$article->externalDetail->photo}}" alt="NA" height="150" width="150">
                    @endif
                </div>
            </div>
        </div>
    ...
    <div class="box-body">
        ...
        @else
            ...
            <div class="thumbnail col-md-3">
                ...
                {!! Form::open(['route'=>['admin.articleFeaturedImage.destroy', $image->id], 'method'=>'delete']) !!}
