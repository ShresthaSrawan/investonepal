...
<div class="box box-info">
    <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-newspaper-o fa-fw"></i> News :List:</h3>
    ...
    <div class="box-footer clearfix">
        <a class="btn btn-primary btn-sm btn-flat pull-right" href="{{route('admin.news.create')}}">
            <i class="fa fa-plus"></i> Add News
        </a>
    </div>
</div>
        ...
        $('.datatable').DataTable({
            ...
            columns: [
                ...
                {data: 'pub_date',name:'pub_date',searchable:false,render:function(date,type,row,meta){
                    action = '\
                    <form method="POST" action="{{url("/")}}/admin/news/' + row.id + '" accept-charset="UTF-8">\
                    <input name="_method" type="hidden" value="DELETE">\
                    <input name="_token" type="hidden" value="{{csrf_token()}}">\
                        <a href="{{url("/")}}/admin/news/'+ row.id +'" class="btn btn-primary btn-xs">\
