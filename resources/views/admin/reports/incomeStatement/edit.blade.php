...
<div class="box box-info">
    {!! Form::open(['route'=>['admin.financialReport.incomeStatement.update','fid'=>$financialReport->id],'class'=>'form-horizontal', 'method'=>'put']) !!}
	    <div class="box-header with-border">
	    	<table class="table-condensed borderless">
	            <thead>
	                <th style="font-size: 25px; font-weight: 400">
	                    <i class="fa fa-file"></i> Income Statement :Edit:
	                </th>
	            </thead>
	            <tbody>
	                <tr>
        ...
        <div class="box-body">
            ...
            <div class="labels">
				<?php $counter = 0 ?>
				@foreach ($financialReport->incomeStatement as $isi)
				<div class="form-group">
					<div class="col-md-4 col-md-offset-2 col-xs-10">
						{!! Form::select('reportLabel['.$counter.']',$reportLabel,$isi->reportLabel->id,['class'=>'form-control reportLabel','required'=>''])!!}
					</div>
					<div class="col-md-3 col-xs-10">
						{!! Form::input('number','value['.$counter.']',$isi->value,['step'=>'any','class'=>'form-control', 'id'=>'reportLabel','required'=>''])!!}
					</div>
					<div class="col-xs-1">
				...
				<?php
					$counter++; 
					if ($counter==count($financialReport->incomeStatement)):
						break;
					endif;
				?>
				@endforeach
