...
<div class="box box-info">
    {!! Form::open(['route'=>['admin.financialReport.principalIndicators.update','fid'=>$financialReport->id],'class'=>'form-horizontal', 'method'=>'put']) !!}
	    <div class="box-header with-border">
	    	<table class="table-condensed borderless">
	            <thead>
	                <th style="font-size: 25px; font-weight: 400">
	                    <i class="fa fa-file"></i> Principal Indicators :Edit:
	                </th>
	            </thead>
	            <tbody>
	                <tr>
        ...
        <div class="box-body">
            ...
            <div class="labels">
				<?php $counter = 0 ?>
				@foreach ($financialReport->principalIndicators as $pi)
				<div class="form-group">
					<div class="col-md-4 col-md-offset-2">
						{!! Form::select('reportLabel['.$counter.']',[''=>'']+$reportLabel,$pi->reportLabel->id,['class'=>'form-control reportLabel'])!!}
					</div>
					<div class="col-md-3">
						{!! Form::input('number','value['.$counter.']',$pi->value,['step'=>'any','class'=>'form-control', 'id'=>'reportLabel','required'=>''])!!}
					</div>
					<div class="col-md-1">
				...
				<?php
					$counter++; 
					if ($counter==count($financialReport->principalIndicators)):
						break;
					endif;
				?>
				@endforeach
