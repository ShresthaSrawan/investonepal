...
<div class="box box-info">
    {!! Form::open(['route'=>['admin.financialReport.principalIndicators.store', $financialReport->id], 'class'=>'form-horizontal']) !!}
	    <div class="box-header with-border">
	    	<table class="table-condensed borderless">
	            <thead>
	                <th style="font-size: 25px; font-weight: 400">
	                    <i class="fa fa-file"></i> Principal Indicators :Create:
	                </th>
	            </thead>
	            <tbody>
	                <tr>
        ...
        <div class="box-body">
            ...
            <div class="labels">
				<?php $counter = 0 ?>
				@foreach($reportLabel as $id=>$label)
				<div class="form-group">
					<div class="col-md-4 col-md-offset-2 col-xs-10">
						{!! Form::select('reportLabel['.$counter.']',[''=>'']+$reportLabel,$id,['class'=>'form-control reportLabel','data-placeholder'=>'Select a label.','required'=>''])!!}
					</div>
					<div class="col-md-3 col-xs-10">
						{!! Form::input('number','value['.$counter.']',null,['step'=>'any','class'=>'form-control', 'id'=>'reportLabel','required'=>''])!!}
					</div>
					<div class="col-xs-1">
