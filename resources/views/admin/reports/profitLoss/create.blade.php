...
<div class="box box-info">
    {!! Form::open(['route'=>['admin.financialReport.profitLoss.store', $financialReport->id], 'class'=>'form-horizontal']) !!}
	    <div class="box-header with-border">
	    	<table class="table-condensed borderless">
	            <thead>
	                <th style="font-size: 25px; font-weight: 400">
	                    <i class="fa fa-file"></i> Profit &amp; Loss :Create:
	                </th>
	            </thead>
	            <tbody>
	                <tr>
            ...
            <div class="labels">
				...
				<div class="form-group">
					<div class="col-md-4 col-md-offset-2 col-xs-10">
						{!! Form::select('reportLabel['.$counter.']',[''=>'']+$reportLabel,$id,['class'=>'form-control reportLabel'])!!}
					</div>
