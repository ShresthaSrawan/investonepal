...
@section('content')
    <div class="box box-info">
        <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-bar-chart-o fa-fw"></i> Economy <small>:Create</small></h3>
            <div class="box-tools pull-right">
                <a class="btn btn-info btn-flat btn-xs" href="{{route('admin.economy.index')}}"><i class="fa fa-eye"></i> View</a>
            </div>
        </div>
        {!! Form::open(['route'=>'admin.economy.store','class'=>'form-horizontal']) !!}
        <div class="box-body">
            ...
            <div id="template" class="hide">
                <div class="form-group group{increment}">
                    ...
                    <div class="col-lg-4">
                        ...
                        {!! Form::input('text','value[{increment}]',null,['class'=>'form-control','step'=>'any']) !!}
                    </div>
                    <div class="col-lg-4">
...
@section('endscript')
    ...
    <script type="text/javascript">
        ...
        function countAvailableEntry(){
            this.dCount = $('.dynamic').find('.form-group').length + 2;
