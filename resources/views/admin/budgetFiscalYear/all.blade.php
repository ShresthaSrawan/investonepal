...
<div class="box box-info">
    <div class="box-header with-border">
        <h3 class="box-title">
            <i class="fa fa-calendar fa-fw"></i> Budget Fiscal Year :List:
        </h3>
        {!! Form::open(['route' => 'admin.budgetFiscalYear.store']) !!}
            ...
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-primary btn-sm editbtn" data-label="{{$year->label}}" 
                        ...
                        data-url="{{route('admin.budgetFiscalYear.update',$year->id)}}">
                        <i class="fa fa-edit"></i>
                    </button>
                    <a href="{{route('admin.budgetFiscalYear.show',$year->id)}}" class="btn btn-primary btn-sm">
                        <i class="fa fa-eye"></i> Budget Report
                    </a>
                </td>
            </tr>
            @endforeach
