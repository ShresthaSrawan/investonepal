...
*/
	...
	return array(
		...
		'allow_close_questions' => 'Allow discussions to be manually closed:',
		'allow_login_email_only' => 'Only log in by email address (not username):',
		'allow_multi_answers' => 'Allow multiple replies per user:',
		'allow_no_category' => 'Allow discussions with no category',
		'allow_no_sub_category' => 'Allow discussions with a category but no sub-category',
		'allow_private_messages' => 'Enable private messaging between users:',
		'allow_self_answer' => 'Allow users to reply their own discussion:',
		'allow_user_walls' => 'Enable wall posts on user profiles:',
		'allow_view_q_bots' => 'Allow search engines to view discussion pages',
		...
		'avatar_q_list_size' => 'Avatar size on discussion lists:',
		'avatar_q_page_a_size' => 'Avatar size on replies:',
		'avatar_q_page_c_size' => 'Avatar size on comments:',
		'avatar_q_page_q_size' => 'Avatar size on discussions:',
		...
		'comment_on_as' => 'Allow comments on replies:',
		'comment_on_qs' => 'Allow comments on discussions:',
		...
		'default_sidebar' => 'Welcome to ^, where you can start discussions and receive replies from other members of the community.',
		'default_subject' => 'A message from ^',
		'default_suffix' => 'Q&A',
		'default_terms' => 'I agree to the ^ Terms & Conditions and Privacy Policy',
		'do_ask_check_qs' => 'Check for similar discussions when starting:',
		'do_close_on_select' => 'Close discussions with a selected reply:',
		'do_complete_tags' => 'Show matching tags while typing:',
		'do_count_q_views' => 'Count the number of discussion views:',
		'do_example_tags' => 'Show example tags based on discussion:',
		'editor_for_as' => 'Default editor for replies:',
		'editor_for_cs' => 'Default editor for comments:',
		'editor_for_qs' => 'Default editor for discussions:',
		'email_privacy' => 'Privacy note for email addresses - HTML allowed:',
		'extra_field_active' => 'Custom field for extra information on start form:',
		'extra_field_display' => 'Show the extra information on discussion pages',
		'extra_field_display_label' => 'Show the extra information on discussion pages with label:',
		'feed_for_activity' => 'Feed for recent activity:',
		'feed_for_hot' => 'Feed for hot discussions:',
		'feed_for_qa' => 'Feed for recent discussions and replies:',
		'feed_for_questions' => 'Feed for recent discussions:',
		'feed_for_search' => 'Feeds for search results:',
		'feed_for_tag_qs' => 'Feed for each tag\'s discussions:',
		'feed_for_unanswered' => 'Feed for unreplied discussions:',
		...
		'follow_on_as' => 'Allow discussions to be related to replies:',
		'from_email' => 'Sender address for messages from site:',
		'hot_weight_a_age' => 'Discussion has a new reply:',
		'hot_weight_answers' => 'Discussion has many replies:',
		'hot_weight_q_age' => 'Discussion is new:',
		'hot_weight_views' => 'Discussion has many views:',
		'hot_weight_votes' => 'Discussion has many up votes:',
		...
		'match_4' => 'Wider',
		'match_5' => 'Widest',
		'match_ask_check_qs' => 'Similar discussions matching:',
		'match_example_tags' => 'Example tags matching:',
		'match_related_qs' => 'Related discussions matching:',
		'max_len_q_title' => 'Maximum length of discussion title:',
		'max_num_q_tags' => 'Maximum number of tags:',
		'max_rate_ip_as' => 'Rate limit for adding replies:',
		...
		'max_rate_ip_qs' => 'Rate limit for starting discussions:',
		...
		'max_rate_user_as' => 'Maximum replies per user per hour:',
		...
		'max_rate_user_qs' => 'Maximum discussions per user per hour:',
		'max_rate_user_uploads' => 'Maximum uploads per user per hour:',
		'max_rate_user_votes' => 'Maximum votes per user per hour:',
		'min_len_a_content' => 'Minimum length of reply:',
		'min_len_c_content' => 'Minimum length of comment:',
		'min_len_q_content' => 'Minimum length of discussion body:',
		'min_len_q_title' => 'Minimum length of discussion title:',
		...
		'notify_admin_q_post' => 'Email this address when a discussion is posted',
		'notify_users_default' => 'Check email notification box by default:',
		'option_default' => 'Default',
		'page_size_activity' => 'Length of All Activity page:',
		'page_size_ask_check_qs' => 'Maximum similar discussions to show:',
		...
		'points_a_selected' => 'Having your reply selected as the best:',
		'points_a_voted_max_gain' => 'Limit from up votes on each reply:',
		'points_a_voted_max_loss' => 'Limit from down votes on each reply:',
		'points_base' => 'Add for all users:',
		'points_multiple' => 'Multiply all points:',
		'points_per_a_voted_down' => 'Per down vote on your reply:',
		'points_per_a_voted_up' => 'Per up vote on your reply:',
		'points_per_q_voted_down' => 'Per down vote on your discussion:',
		'points_per_q_voted_up' => 'Per up vote on your discussion:',
		'points_post_a' => 'Posting an reply:',
		'points_post_q' => 'Posting a discussion:',
		'points_q_voted_max_gain' => 'Limit from up votes on each discussion:',
		'points_q_voted_max_loss' => 'Limit from down votes on each discussion:',
		'points_select_a' => 'Selecting an reply for your discussion:',
		'points_vote_down_a' => 'Voting down an reply:',
		'points_vote_down_q' => 'Voting down a discussion:',
		'points_vote_up_a' => 'Voting up an reply:',
		'points_vote_up_q' => 'Voting up a discussion:',
		'q_urls_remove_accents' => 'Remove accents from discussion URLs:',
		'q_urls_title_length' => 'Discussion title length in URLs:',
		'register_notify_admin' => 'Email me when a new user registers:',
		'search_module' => 'Use search module:',
		'show_a_form_immediate' => 'Show reply form immediately:',
		'show_always' => 'Always',
		'show_c_reply_buttons' => 'Show reply button on comments:',
		'show_custom_answer' => 'Custom message on reply form - HTML allowed:',
		'show_custom_ask' => 'Custom message on start form - HTML allowed:',
		...
		'show_selected_first' => 'Move selected reply to the top:',
		...
		'show_view_count_q_page' => 'Show view count on discussion pages:',
		'show_view_counts' => 'Show view count in discussion lists:',
