...
*/
	...
	return array(
		...
		'categories_not_shown' => 'Some discussions have categories which will not be displayed.',
		...
		'category_no_sub_error' => '^q discussion/s in this category have no sub-category - ^1set sub-category^2',
		'category_no_sub_to' => 'Move discussions in ^ with no sub-category to:',
		'category_no_subs' => 'None',
		'category_none_error' => '^q discussion/s currently have no category - ^1set category^2',
		'category_none_to' => 'Move discussions with no category to:',
		...
		'delete_category_reassign' => 'Delete this category and reassign its discussions to:',
		...
		'delete_hidden_note' => ' - all hidden discussions, reply and comments without dependents',
		...
		'hidden_answers_deleted' => 'Deleted ^1 of ^2 hidden replies without dependents...',
		'hidden_comments_deleted' => 'Deleted ^1 of ^2 hidden comments...',
		'hidden_questions_deleted' => 'Deleted ^1 of ^2 hidden discussions without dependents...',
		'hidden_title' => 'Hidden',
		'hotness_factors' => 'Relative importance for discussion hotness:',
		...
		'q2a_version' => 'Discussion2Reply version:',
		'question_lists' => 'Discussion lists',
		'question_pages' => 'Discussion pages',
		...
		'recalc_categories_recounting' => 'Recounting discussions for ^1 of ^2 categories...',
		...
		'recalc_posts_count' => 'Getting total number of discussions, replies and comments...',
		...
		'recount_posts_as_recounted' => 'Recounted replies and hotness for ^1 of ^2 posts...',
		'recount_posts_complete' => 'All posts were successfully recounted.',
		'recount_posts_note' => ' - the number of replies, votes, flags and hotness for each post',
		...
		'refill_events_refilled' => 'Refilled for ^1 of ^2 discussions...',
		'registration_fields' => 'add registration fields',
		'reindex_content' => 'Reindex content',
		'reindex_content_note' => ' - for searching and related discussion suggestions',
		...
		'requires_q2a_version' => 'Disabled - requires Discussion2Reply ^ or later',
		...
		'tags_not_shown' => 'Some discussions have tags which will not be displayed.',
		...
		'total_as' => 'Total replies:',
		'total_cs' => 'Total comments:',
		'total_qs' => 'Total discussions:',
		'unnamed_plugin' => 'Unnamed Plugin',
		'upgrade_db' => 'Your Discussion2Reply database needs to be ^1upgraded^2 for this version.',
