...
*/
	...
	return array(
		'a_commented_body' => "Your reply on ^site_title has a new comment by ^c_handle:\n\n^open^c_content^close\n\nYour reply was:\n\n^open^c_context^close\n\nYou may respond by adding your own comment:\n\n^url\n\nThank you,\n\n^site_title",
		'a_commented_subject' => 'Your ^site_title reply has a new comment',

		'a_followed_body' => "Your reply on ^site_title has a new related discussion by ^q_handle:\n\n^open^q_title^close\n\nYour reply was:\n\n^open^a_content^close\n\nClick below to reply the new discussion:\n\n^url\n\nThank you,\n\n^site_title",
		'a_followed_subject' => 'Your ^site_title reply has a related discussion',

		'a_selected_body' => "Congratulations! Your reply on ^site_title has been selected as the best by ^s_handle:\n\n^open^a_content^close\n\nThe discussion was:\n\n^open^q_title^close\n\nClick below to see your reply:\n\n^url\n\nThank you,\n\n^site_title",
		'a_selected_subject' => 'Your ^site_title reply has been selected!',
		...
		'q_answered_body' => "Your discussion on ^site_title has been replied by ^a_handle:\n\n^open^a_content^close\n\nYour discussion was:\n\n^open^q_title^close\n\nIf you like this reply, you may select it as the best:\n\n^url\n\nThank you,\n\n^site_title",
		'q_answered_subject' => 'Your ^site_title discussion was replied',

		'q_commented_body' => "Your discussion on ^site_title has a new comment by ^c_handle:\n\n^open^c_content^close\n\nYour discussion was:\n\n^open^c_context^close\n\nYou may respond by adding your own comment:\n\n^url\n\nThank you,\n\n^site_title",
		'q_commented_subject' => 'Your ^site_title discussion has a new comment',

		'q_posted_body' => "A new discussion has been started by ^q_handle:\n\n^open^q_title\n\n^q_content^close\n\nClick below to see the discussion:\n\n^url\n\nThank you,\n\n^site_title",
		'q_posted_subject' => '^site_title has a new discussion',
