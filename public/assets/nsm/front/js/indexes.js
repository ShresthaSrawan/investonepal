        ...
        if(table===undefined){
            table = $('table.index').DataTable({
                ...
                columns: [
                    ...
                    {data: 'previous',searchable:false,class:'hidden-sm hidden-xs',render:function(data){
                        if(data===null) return 'N/A';
                        return data;
                    }},
                    ...
                    {data: 'percent',searchable:false,class:'hidden-sm hidden-xs',render:function(data){
                        if(data===null) return 'N/A';
                        if(eval(data)>0)
                            change = "up";
                        else if(eval(data)<0)
